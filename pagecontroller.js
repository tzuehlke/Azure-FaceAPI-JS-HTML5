var PageController = (function() {
    ...
    function draw(){
        ...
        for(i=0; i<FaceAnalyse.getFaces().length; i++){
			...
			var bottom = face.faceRectangle.top + face.faceRectangle.height;
            context.beginPath();
            context.fillStyle = 'yellow';
            context.font = '14pt Calibri';
            context.fillText("Age " + face.faceAttributes.age, face.faceRectangle.left + 10, bottom - 84);
            context.fillText(face.faceAttributes.gender, face.faceRectangle.left + 10, bottom - 70);
			context.fillText("😀 " + face.faceAttributes.emotion.happiness, face.faceRectangle.left + 10, bottom - 50);
			context.fillText("🙁 " + face.faceAttributes.emotion.sadness, face.faceRectangle.left + 10, bottom - 30);
			context.fillText("😠 " + face.faceAttributes.emotion.anger, face.faceRectangle.left + 10, bottom - 10);
            context.stroke();
            context.beginPath();
            context.lineWidth="3";
